...
public class Controle {
	...
	private int proximoJogador; //é pra marcar o numero de quem esta na vez de jogar
	private int fimDeJogo; //isso eh pra avisar pra main qnd o jogo terminou; LEMBRAR DE IR ATUALIZANDO ISSO EM ALGUM LUGAR
	private int numDado;
	...
	public Controle(int qtdJogadores, Tabuleiro tabuleiro) {
		...
		this.proximoJogador = 1; //sempre começa com o jogador 1 
	...
	public String corSelecionada(int num) { //função para pegar a cor que a pessoa escolheu para jogar, nsei se deveria estar aqui e nem como fazer isso ainda, pois depende da interface
